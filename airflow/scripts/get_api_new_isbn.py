...
def get_json_data(page_no, api_key):
    ...
    option = "&QueryType=ItemNewAll&MaxResults=100&SearchTarget=Book&output=JS&Version=20131101&start=" + str(page_no)
...
if __name__ == "__main__":
    ...
    today = datetime.now().strftime("%Y-%m-%d") #추후 airflow 환경의 날짜를 가지고 와 해당 날짜를 조회하도록 수정 예정
